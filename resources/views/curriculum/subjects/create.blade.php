				...
				<div class="row mb-2">
					...
					<div class="col-sm-6">
						<ol class="breadcrumb float-sm-right">
							...
							<li class="breadcrumb-item"><a href="{{route('curriculums.show', $curriculum->id)}}">{{$curriculum->course->course_name}}</a></li>
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<add-subjects-form :curriculum="{{$curriculum}}"></add-subjects-form>
					</div>
				</div>
			</div>
			<!-- /.container-fluid -->
