	...
	<div class="card">
		<div class="card-header">
			...
			<div class="card-tools">
				<button type="button" class="btn btn-sm btn-primary" @click="addNewRegistrar">
...
export default {
	...
	data() {
		return {
			url: "http://localhost:8000/api/users/registrars",
	...
	methods: {
		...
		addNewRegistrar() {
			window.location.href = "http://localhost:8000/users/registrars/create";
		}
	}
}
</script>